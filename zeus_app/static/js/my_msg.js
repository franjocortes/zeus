...
const message_info = (msg = 'Mensaje', url = '', function_ok = null) => {
    Swal.fire({
        position: 'top-end',
        icon: 'success',
        title: msg,
...
const message_question = (msg = 'Mensaje', function_ok) => {
    Swal.fire({
        title: '¿Está seguro?',
        text: msg,
        icon: 'warning',
...
const submitWithAjax = (title, message, url, parameters, callback) => {
    Swal.fire({
        title: title,
        text: message,
        icon: "question",
