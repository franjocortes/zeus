...
class Products(models.Model):
    ...
    price_sell_min = models.DecimalField(default=0.00, max_digits=12, decimal_places=2, verbose_name='Precio Venta MIN')
    price_sell_may = models.DecimalField(default=0.00, max_digits=12, decimal_places=2, verbose_name='Precio Venta MAY')
